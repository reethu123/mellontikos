<!DOCTYPE html>
<html>
  <title>Mellontikos Hosptial || Dashboard </title>
  <meta charset="UTF-8">
  ...
  <body>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
      ...
      <div class="w3-container" style="margin-top:80px" id="showcase">
        <h1 class="w3-jumbo"><b>Welcome, <?php echo $name; ?></b></h1>
      ...
      <div class="w3-container" id="services" style="margin-top:75px">
        <h1 class="w3-xxxlarge w3-text-red"><b>Personal Details</b></h1>
        <hr style="width:50px;border:5px solid red" class="w3-round">
        <p><h3>Name :</h3> <?php echo $name; ?></p>
        <p><h3>Gender :</h3><?php echo $gender; ?></p>
        <p><h3>Age :</h3><?php echo $age; ?></p>
        <p><h3>Moblie no :</h3><?php echo $moblie; ?></p>
        <p><h3>Email Id :</h3><?php echo $email; ?></p>
