...
<!DOCTYPE html>
<html>
  <title>Mellontikos Hosptial || Departments </title>
  <meta charset="UTF-8">
  ...
  <body>
    ...
    <?php
      // Department List
      $list = mysqli_query($conn,"select * from department_list ");
    ?>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
      ...
      <div class="w3-container" style="margin-top:60px" id="showcase">
        <h1 class="w3-jumbo"><b>Departments</b></h1>     
      </div>
      ...
      <div  id="services" style="margin-top:30px">
        ...
        <table id="list">
          ...
          <?php
            ...
            {
              echo '<tr><td><a href="Doctors_list.php?id='.$id.'&dept_id='.$dep_list[0].'" title="Department Of '.$dep_list[1].'">' . $dep_list[1] . '</a></td><td>' . $dep_list[2] . '</td></tr></a>';
            }
          ?>
        </table>
